        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Administração - Siga Web</a>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li class="active">
                            <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> Administração </a>
                        </li>
                        <li>
                            <a href="usuario.html"><i class="fa fa-fw fa-bar-chart-o"></i> Usuários</a>
                        </li>
                        <li>
